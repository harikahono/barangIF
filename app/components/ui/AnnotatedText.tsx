...
// ponytail: warna di-retheme ke netral biar cocok tema monochrome barangIF
const annotationStyles = {
  ...
  highlight: {
    ...
    defaultColor: "text-neutral-400/60",
  },
  underline: {
    wrapper: "relative inline-block whitespace-nowrap",
  ...
  ({ children, variant = "wavy", color, className }, ref) => {
      ...
      return (
        <>
          ...
          <span ref={ref} className={cn(style.wrapper, className)}>
            <span className="relative z-10 font-normal">{children}</span>
    ...
    return (
      <>
        ...
        <span
          ref={ref}
          className={cn(style.wrapper, "font-normal", className)}
        >
          {children}
