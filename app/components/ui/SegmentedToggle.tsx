    ...
    return (
      <div
        ...
        className={cn(
          ...
          "shadow-[inset_0_1px_2px_rgba(0,0,0,0.08),inset_0_2px_4px_rgba(0,0,0,0.05),inset_0_-2px_3px_rgba(0,0,0,0.06),0_1px_0_var(--color-toggle-sheen)]",
      ...
      >
        <span
          ...
          className={cn(
            ...
            "shadow-[0_2px_4px_rgba(0,0,0,0.15),0_1px_1px_rgba(0,0,0,0.08),inset_0_1px_0_var(--color-toggle-sheen),inset_0_-2px_3px_rgba(0,0,0,0.06)]",
            SEGMENT_MOTION,
